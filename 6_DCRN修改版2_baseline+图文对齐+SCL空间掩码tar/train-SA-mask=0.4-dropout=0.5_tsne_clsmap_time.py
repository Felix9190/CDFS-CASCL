...
seeds = [1214] # best classification map and t-SNE
...
fig = utils.plot_embedding_2D(result_2D, labels, 'SA', color_map)
fig.savefig("tsne/SNE_SA.png")
fig.savefig("tsne/SNE_SA.pdf")
