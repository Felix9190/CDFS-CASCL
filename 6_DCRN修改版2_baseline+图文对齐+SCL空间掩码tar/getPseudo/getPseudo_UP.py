...
# SA getPseudo
image_file = os.path.join('../../../datasets', 'paviaU/paviaU.mat')
label_file = os.path.join('../../../datasets', 'paviaU/paviaU_gt.mat')
...
img = np.asarray(data_all[:,:,[65,40,30]]) #
