...
config['target_data'] = 'WHU-Hi-LongKou/WHU_Hi_LongKou.mat'
config['target_data_gt'] = 'WHU-Hi-LongKou/WHU_Hi_LongKou_gt.mat'
...
train_opt['tar_class_num'] = 9 # 以目标域类别作为元任务类别数。
