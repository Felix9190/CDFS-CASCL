...
# seeds = [1222, 1223] # IP final seeds version
...
for iDataSet in range(nDataSet) :
    ...
    for episode in range(EPISODE) :
        ...
        # augment2_support_proto_tar = torch.FloatTensor(data_augment.random_mask_batch_image(support_tar.data.cpu(), 0.8)) # (16, 200, 7, 7)
