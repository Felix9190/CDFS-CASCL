...
config['target_data'] = 'WHU-Hi-HanChuan/WHU_Hi_HanChuan.mat'
config['target_data_gt'] = 'WHU-Hi-HanChuan/WHU_Hi_HanChuan_Extract15%_gt.mat'
...
train_opt['lambda_1'] = 0.1 # SimSiam对比学习
train_opt['d_emb'] = 128 # 嵌入向量维度
train_opt['src_input_dim'] = 128
train_opt['tar_input_dim'] = 274
train_opt['n_dim'] = 100
...
train_opt['tar_class_num'] = 16 # 以目标域类别作为元任务类别数。
